...
class  Mainnav extends Component {
    constructor(props){
      ...
      //  const mediaSource = new MediaSource();
        ...
        //  youtubeView
      //   this.remoteView.current.srcObject = (e.stream[0]);
         this.youtubeView.current.srcObject = (e.stream);
    ...
    render() { 
        ...
        <div><h5>WebRT</h5>
                  ...
                  <h3><video className='video' ref={this.youtubeView} autoPlay muted={true}></video>
</h3>
            <h1>
           <br></br>
